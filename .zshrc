...
ysas() {
	ys https://admin.staging.injuryprofiler.net "$(op read 'op://Employee/Injuryprofiler/username')" "$(op read 'op://Employee/Injuryprofiler/password')" $1
}

ysap() {
	ys https://admin.injuryprofiler.com "$(op read 'op://Employee/Injuryprofiler/username')" "$(op read 'op://Employee/Injuryprofiler/password')" $1
}
